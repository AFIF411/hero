              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">contact@feteplan.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-800 dark:text-gray-200">Téléphone</p>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-800 dark:text-gray-200">Adresse</p>
                    <p className="text-gray-600 dark:text-gray-400">
                      123 Rue de la Fête<br />
                      75001 Paris, France
                    </p>
                  </div>
                </div>
