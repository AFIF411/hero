...
interface Product {
  ...
  name: string;
  price: number;
  image: string; // soit un emoji, soit /images/...
...
const productOptions: Record<string, ProductOptions> = {
  decoration: {
    sizes: ["Petit", "Moyen", "Grand", "Extra Large"],
    colors: [
      "Rouge",
      "Bleu",
      "Vert",
  ...
  menu: {
    sizes: ["Individual", "Pour 5 pers.", "Pour 10 pers.", "Pour 20 pers."],
    colors: [],
    tastes: ["Vanille", "Chocolat", "Fraise", "Citron", "Caramel", "Fruits rouges"],
  },
  photographe: {
    sizes: ["2h", "4h", "6h", "Journée complète"],
    colors: [],
    tastes: [],
  },
  cadeaux: {
    sizes: ["Petit", "Moyen", "Grand"],
    colors: ["Rouge", "Bleu", "Vert", "Jaune", "Rose", "Violet"],
    tastes: [],
  },
  invitations: {
    sizes: ["Pack 10", "Pack 25", "Pack 50", "Pack 100"],
    colors: ["Blanc", "Crème", "Bleu", "Vert", "Rose"],
    tastes: [],
  },
};
